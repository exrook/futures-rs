...
pub mod sink {
    ...
    #[doc(inline)]
    pub use crate::sink::{unfold_fns as unfold, SinkExtFns as SinkExt};
}
#[cfg(feature = "fntraits")]
pub mod stream {
    ...
    pub use crate::stream::{
        poll_fn_fns as poll_fs, repeat_with_fns as repeat_with, try_unfold_fns as try_unfold,
        unfold_fns as unfold, StreamExtFns, TryStreamExtFns,
    };
}
