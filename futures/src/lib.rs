...
pub mod future {
    ...
    pub use futures_util::future::{
        ...
        IntoStream, Join, Join3, Join4, Join5, Lazy, Map, MapErr, MapInto, MapOk, MapOkOrElse,
        MaybeDone, NeverError, OkInto, OptionFuture, OrElse, Pending, PollFn, Ready, Select, Then,
        TryFlatten, TryFlattenStream, TryFutureExt, TryJoin, TryJoin3, TryJoin4, TryJoin5,
        TrySelect, UnitError, UnwrapOrElse,
    };
    ...
    #[cfg(feature = "std")]
    pub use futures_util::future::{CatchUnwind, Remote, RemoteHandle, Shared, WeakShared};
}
...
pub mod io {
    ...
    pub use futures_util::io::{
        ...
        Empty, FillBuf, Flush, IntoSink, Lines, Read, ReadExact, ReadHalf, ReadLine, ReadToEnd,
